...
export const experience = [
  ...
  },
  {
    ...
    description: [
      "Maintained and organized patient records for weight loss and aesthetic clients, ensuring up-to-date documentation.",
      "Welcomed patients upon arrival, recorded weight, escorted them to their rooms, and retrieved their files prior to appointments.",
    ],
  ...
  },
  {
    ...
    description: [
      "Administered EEG-guided neurofeedback and V-Light therapy sessions for 20+ clients under clinical supervision.",
      "Tracked neurological progress and maintained patient outcome documentation in clinical logs.",
    ],
  ...
  },
  {
    ...
    description: [
      "Conducted 200+ patient intakes including vitals, STD and drug testing, B12 injections, and lab collections.",
      "Operated the BD Veritor diagnostic system to administer and analyze strep, influenza, and COVID-19 rapid tests.",
      "Assisted with Ozempic injections and immigrant medical testing while improving clinic workflow through accurate data log management.",
    ],
